...
<body>
	...
	<form action="<?php echo U('add');?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="telephone" value="<?php echo ($info["telephone"]); ?>">
			</div>
		</div>
		<div class="form-item">
		...
		<div class="form-item">
			<label class="item-label">问题说明</label>
			<div class="controls">
				<input type="text" class="text input-large" name="intro" value="<?php echo ($info["intro"]); ?>">
			</div>
		</div>
		<div class="form-item">
